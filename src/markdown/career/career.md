...
제 장점은 서로 다른 사람들의 눈높이를 캐치해 소통을 돕는 커뮤니케이션 능력이라고 생각합니다.

**더 읽어보기**

세상에는 컴퓨터공학과 출신의 뛰어난 개발자도 많이 있습니다. 하지만 팀에는 다른 분야에 대한 경험이 풍부한 개발자도 반드시 필요하다고 생각합니다. 사회인이 된 이후에 개발을 시작하며 그 어려운 세계를 학습하느라 노력했던 경험이 있기에, 저는 IT 직군과 비 IT의 사고방식 모두를 이해하여 상대에 따른 알맞은 언어로 커뮤니케이션 할 수 있습니다.
...
21년 겨울에 진행했던 DB 마이그레이션 작업과, 20년도에 작업했던 공동인증서 기반 전자어음 서버 스크래핑이 가장 까다로웠던 것 같습니다.

**DB 마이그레이션 작업**

당시 사내 RDS 인스턴스는 무려 1TB에 달하는 스토리지를 갖고 있었습니다. 과거 AWS 테라포밍을 담당했던 외주업체에서 서비스의 성장 가능성을 염두에 두고 지나치게 큰 용량을 할당했던 것인데요. 실제 저희가 사용 중인 용량은 그에 턱없이 못 미쳤기 때문에 불필요한 비용 발생의 원인이 되었습니다. 하지만 RDS 특성상 한번 잡은 스토리지 용량은 늘릴 수는 있어도 줄일 수는 없었고, 더 작은 사이즈로 새로 생성한 인스턴스로
